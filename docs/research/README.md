...
- [Oral-question exchange participant implementation](parliamentary_questions_exchange_metrics_implementation.md) — implemented schema, regression coverage, disposable production-seeded candidate evidence, eight-dataset manifest, permanent audit requirements, and the merge/promotion plan.
