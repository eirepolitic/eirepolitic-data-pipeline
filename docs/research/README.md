...
- [Context-aware voting foundations implementation](contextual_vote_foundations_implementation.md) — deployed additive daily contextual vote numerators/denominators and context-aware party division-vote components, exact reconciliation to existing unfiltered foundations, live production counts, deployment evidence and the living plan for monthly contextual result rows.
