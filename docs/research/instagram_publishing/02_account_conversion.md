...
Scope: determine whether the existing Eirepolitic Instagram personal account can be converted in-place to a professional account without replacing the account or losing its existing audience/history, and document material trade-offs. No account changes were made.
